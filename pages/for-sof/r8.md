...
This file contains a spinning R8 animation, followed by its technical specifications. It's specifically designed to 
make the transition to [M8](../m8) to allow for multidimensional exploration. The third item in this file is a 
snippet of the Top 10 Statues music video, with a grainy black-and-white filter over it. R8 also appears in this 
music video, along with a girl wearing a MOXYPAK designed by [ARC/HIVE](../lore/archive).
...
> 
> NG 
> [Dreamseeker] [Image: Nex Gen logo]
> TP10-TCB IT'S JUST BASIC CHEMISTRY
>
> SOLVE RSCU-M3
> COAGULA 26/03/????
> ASABV_SBLW
...
- [Dallus' diary](dallus-diary) (mention of RO8OT line)
