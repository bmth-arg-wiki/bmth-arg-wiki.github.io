...
tags: ["bmth", "arg", "strassman", "skys", "mantra", "cult", "nex gen", "arc/hive", "operation", "trinity", "dallas", 
       "dallus", "lauren", "ava", "neosages", "dust", "kingslayer", "pusse", "youtopia", "synth"]
...
Early in the ARG, we learn that he helped [E.V.E](../characters/eve) gain control over humanity under false pretences.
...
He was born with the (less rare) white haired variant of radiogenic leukotrichia. The condition is the result 
of nuclear fallout, from a war that started with distrust from Novosovia towards the DTC during Cold War 2.0. 
The war places Strassman's date of birth after 1983, making him 21 when he joins the Mantra cult.

We first see him working with [E.V.E](eve) in a [video](../for-sof/strassmancodec) unlocked on the 26th of May 2024
(IRL) in the [FOR SOF](../for-sof) folder. This was one of the earliest files after the release of the ARG on the 24th, 
introducing us to this key player in the story.

### Neospiritualism (<2004)

Dr. Karl Strassman was a researcher looking into the science of spiritualism. Before getting involved with Skys, 
Strassman founded Neospiritualism, as we learn from [Unbeleevable Episode 2](../for-sof/unbeleevable2).
When [Skys](skys) came to Novosovia with his band [Skys & the Starjammers](../for-sof/skystarjammers) in 2004, 
his eccentric behaviour in interviews caught Strassman's attention. Despite his lack of traditional education, Skys' 
ideas were similar to those of his own cutting-edge research.

Much later in the timeline the [Science Study](../for-sof/thesciencestudy) is released in New Elysium in 2037 
with a picture of young Skys. This newspaper also presents a very critical article on Neospiritualism.

### Neosages (2004-2020)

Strassman's life would change on the 19th of December in 2004, at a Skys & the Starjammers show at the October 
Palace in Novosovia. He was eager to attend the party due to his interest in Skys, convincing his partner 
[Dallus Lauren](dallus-lauren) to come along. They also took their assistant, Ro.

On this evening he met [Ava](ava), a red-haired woman he was immediately enchanted by. His partner Dallus had been hesitant 
...
Ava is Skys' best disciple, and he is not aware of the relationship forming between the two. Strassman sends 
Ava the [Russian Poem](../for-sof/russianpoem). In [Unbeleevable Episode 3](../for-sof/unbeleevable3) it is revealed that 
she is pregnant with Strassman's child. After a Novosovian operative is identified as a traitor in the cult, he is 
used as an example and test subject for [Project Kingslayer](../lore/incident-kingslayer). Since Strassman and Ava are 
still hiding their affair, she begs Strassman to flee from the cult.
...
Strassman does not seem present at the funeral during the video.

### Operation Trinity (~Christmas Day 2020)

[Operation Trinity](../lore/operation-trinity) was a covert operation from the [DTC](../lore/dtc) government, 
...
both Dallus and Strassman had families. Ava had Strassman's child Angel, but had sadly passed away at the 
time of writing. Angel is also missing, presumed dead. This has completely destroyed Strassman. 
Skys has also gone into a coma.
...
would start working closely with.
...
The [LBR sites letter](../for-sof/lbr_sites) is written in 2038 to Victor Carmine and a redacted recipient. 
Strassman writes that two more Lesser Banishing Ritual sites have been approved above ancient Eldritch Conduits in the 
regions Heian-kyō and Naniwa-kyō. Several measures have been taken, due to an accident taking place in the final days 
of Arc/Hive. A [reconstructed interview](../for-sof/carmine_interview) with Carmine refers to the incident as 
"The Cradle Crash", an incident caused by energies exchanged with Dallus' consciousness.
...
managed to successfully synthesise from Selene's unique indole alkaloid structure. He stresses that there are a 
...
when this occurs, but likely after the 2039 events.
